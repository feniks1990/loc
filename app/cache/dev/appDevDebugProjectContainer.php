...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getCacheWarmerService()
    {
        ...
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Doctrine\Bundle\MongoDBBundle\CacheWarmer\ProxyCacheWarmer($this), 1 => new \Doctrine\Bundle\MongoDBBundle\CacheWarmer\HydratorCacheWarmer($this), 2 => new \Doctrine\Bundle\MongoDBBundle\CacheWarmer\PersistentCollectionCacheWarmer($this), 3 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 4 => $this->get('kernel.class_cache.cache_warmer'), 5 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TranslationsCacheWarmer($this->get('translator')), 6 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 7 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c, array()), 8 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer($this->get('twig'), new \Symfony\Bundle\TwigBundle\TemplateIterator($a, $this->targetDirs[2], array()))));
    }
    ...
    protected function getDoctrineMongodb_Odm_DefaultConfigurationService()
    {
        ...
        $b->addDriver(new \Doctrine\ODM\MongoDB\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/mongoDb/mongoBundle/Document'))), 'mongoDb\\mongoBundle\\Document');
        ...
        $instance->setDocumentNamespaces(array('mongoDbmongoBundle' => 'mongoDb\\mongoBundle\\Document'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/url/urlGenBundle/Resources/views'), 'urlurlGen');
        $instance->addPath(($this->targetDirs[3].'/src/mongoDb/mongoBundle/Resources/views'), 'mongoDbmongo');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58f40dfc97e652.92376807')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'urlurlGenBundle' => 'url\\urlGenBundle\\urlurlGenBundle',
                'mongoDbmongoBundle' => 'mongoDb\\mongoBundle\\mongoDbmongoBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'urlurlGenBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/url/urlGenBundle'),
                    'namespace' => 'url\\urlGenBundle',
                ),
                'mongoDbmongoBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/mongoDb/mongoBundle'),
                    'namespace' => 'mongoDb\\mongoBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
